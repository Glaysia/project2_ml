...
def verify_plot(model, data_seen, data_unseen, parameter, xlim=[0,20], ylim=[0,20], legend=True, x_txt="", y_txt="") :
    ...
    plt.xlabel("y" + x_txt, fontsize=fts)
    plt.ylabel("ý" + y_txt, fontsize=fts)
    plt.grid(True)
